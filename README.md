...
![Baseline CV](images/S6E8_CatBoost_Baseline.png)

### Improved Cross-Validation

![Improved CV](images/S6E8_CatBoost_Improved.png)

### FEATURE ENGINEERING

![Model Improvement](images/feature_engineering.png)

### FEATURE KAGGLE SUBMISSION

![Submission](images/submission_kaggle2.png)

### Kaggle Baseline Submission

![Kaggle Baseline Submission](images/submission.png)

### Kaggle Improved Submission

![Kaggle Improved Submission](images/submission_improved.png)
...
│
├── images/
│   ├── S6E8_CatBoost_Baseline.png
│   ├── S6E8_CatBoost_Improved.png
|   ├── feature_engineering.png
│   ├── submission_kaggle.png
│   ├── submission.png
│   └── submission_improved.png
│
└── results/
